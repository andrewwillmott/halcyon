...
namespace ustl
{
    ...
    public:
        ...
        virtual                     ~memblock ();
        virtual void                unlink ();
        inline void                 assign (const cmemlink& l)      { assign (l.m_Data, l.m_Size); }
        ...
        inline bool                 is_linked () const          { return (!m_Capacity); }
        inline size_type            max_size () const           { return (is_linked() ? memlink::max_size() : SIZE_MAX); }
