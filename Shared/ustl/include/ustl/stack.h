...
namespace ustl
{
    ...
    public:
        ...
        inline size_type            size () const               { return (m_Storage.size()); }
        inline reference            top ()                      { return (m_Storage.back()); }
        inline const_reference      top () const                { return (m_Storage.back()); }
        inline void                 push (const value_type& v)      { m_Storage.push_back (v); }
        inline void                 pop ()                      { m_Storage.pop_back(); }
