...
namespace ustl
{
    ...
    public:
        ...
        inline Iterator             base () const { return (m_i); }
        inline reference            operator* () const { Iterator prev (m_i); --prev; return (*prev); }
        inline pointer              operator-> () const { return (&(operator*())); }
        inline reverse_iterator&    operator++ () { -- m_i; return (*this); }
        inline reverse_iterator&    operator-- () { ++ m_i; return (*this); }
    ...
    public:
        ...
        inline insert_iterator&     operator* ()  { return (*this); }
        inline insert_iterator&     operator++ () { ++ m_ip; return (*this); }
    ...
    public:
        ...
        inline back_insert_iterator&        operator* ()  { return (*this); }
        inline back_insert_iterator&        operator++ () { return (*this); }
    ...
    public:
        ...
        inline bool                 operator< (const RandomAccessIterator& i) const { return (m_Base < i); }
        inline IndexIterator        base () const { return (m_i); }
        inline reference            operator* () const { return (advance(m_Base, *m_i)); }
        inline pointer              operator-> () const { return (&(operator*())); }
        inline index_iterate&       operator++ () { ++ m_i; return (*this); }
        inline index_iterate&       operator-- () { -- m_i; return (*this); }
