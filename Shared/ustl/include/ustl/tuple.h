...
namespace ustl
{
    ...
    public:
        ...
        inline iterator             begin ()                    { return (m_v); }
        inline const_iterator       begin () const              { return (m_v); }
        inline iterator             end ()                      { return (begin() + N); }
        ...
        inline size_t               stream_size () const                { return (nr_container_stream_size (*this)); }
    private:
        T                           m_v [N];
    };
...
template <> inline tuple<n,type>::tuple ()                                  \
...
template <> inline tuple<2,type>::tuple ()  \
