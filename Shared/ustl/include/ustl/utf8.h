...
namespace ustl
{
    ...
    public:
        ...
        inline Iterator             base () const       { return (m_i - (Utf8Bytes(m_v) - 1)); }
        /// Reads and returns the next value.
        inline WChar                operator* () const  { return (m_v); }
        inline utf8in_iterator&     operator++ ()       { ++m_i; Read(); return (*this); }
    ...
    void utf8in_iterator<Iterator,WChar>::Read ()
    {
    ...
    public:
        ...
        inline const Iterator&      base () const { return (m_i); }
        /// Writes \p v into the stream.
        utf8out_iterator&           operator= (WChar v);
        inline utf8out_iterator&    operator* () { return (*this); }
        inline utf8out_iterator&    operator++ () { return (*this); }
