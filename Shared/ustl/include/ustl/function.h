...
MEM_FUN_T(mem_fun,      mem_fun_t,              T*,             (),         ->*)
MEM_FUN_T(mem_fun,      const_mem_fun_t,        const T*,       () const,   ->*)
MEM_FUN_T(mem_fun_ref,  mem_fun_ref_t,          T&,             (),         .*)
MEM_FUN_T(mem_fun_ref,  const_mem_fun_ref_t,    const T&,       () const,   .*)
