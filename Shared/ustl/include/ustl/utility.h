...
#if CPU_HAS_3DNOW
    inline void reset_mmx () { asm ("femms":::ALL_MMX_REGS_CHANGELIST); }
#elif CPU_HAS_MMX
    inline void reset_mmx () { asm ("emms":::ALL_MMX_REGS_CHANGELIST); }
#else
    inline void reset_mmx () {}
#endif
} // namespace simd
}
