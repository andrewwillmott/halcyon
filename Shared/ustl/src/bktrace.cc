...
void CBacktrace::GetSymbols () throw()
{
...
{
    UASSERT(is.aligned (stream_align_of (m_Addresses[0])) && "Backtrace object contains pointers and must be void* aligned");
...
{
    UASSERT(os.aligned (stream_align_of (m_Addresses[0])) && "Backtrace object contains pointers and must be void* aligned");
...
size_t CBacktrace::stream_size () const
{
